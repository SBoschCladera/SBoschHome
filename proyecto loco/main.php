...
$provincias = ["M" => "Madrid", "B" => "Barcelona","V" => "Valencia","A" => "Alicante","S" => "Sevilla","MA" => "Málaga","MU" => "Murcia",
    "CA" => "Cádiz","PM" => "Baleares","C" => "La Coruña","GC" => "Las Palmas", "BI" => "Vizcaya","O" => "Asturias", "GR" => "Granada",
    "PO" =>  "Pontevedra", "TF" => "Santa Cruz de Tenerife" ,"Z" => "Zaragoza" ,"AL" => "Almería", "BA" => "Badajoz","CO" => "Córdoba",
    "GI" => "Gerona", "SS" => "Guipúzcoa", "T" => "Tarragona","TO" => "Toledo","S" => "Cantabria", "CS" => "Castellón", "CR" => "Ciudad Real",
    "H" => "Huelva", "J" => "Jaén", "NA" => "Navarra",    "VA" =>  "Valladolid","VI" => "Álava", "AB" => "Albacete", "BU" => "Burgos",
    "CC" => "Cáceres", "LE" => "León", "L" => "Lérida", "LU" => "Lugo", "OR" => "Orense", "LO" => "La Rioja", "SA" => "Salamanca", "AV" =>  "Ávila",
    "CU" => "Cuenca","GU" =>  "Guadalajara", "HU" => "Huesca", "P" => "Palencia", "SG" => "Segovia", "TE" => "Teruel", "ZA" => "Zamora","SO" => "Soria",
    "CE" => "Ceuta","ML" => "Melilla"];



$circunscripciones = ["Madrid" => "37", "Barcelona"=> "32","Valencia"=> "15","Alicante"=> "12","Sevilla"=> "12","Málaga"=> "11",
    "Murcia"=> "10","Cádiz"=> "9","Baleares"=> "8","La Coruña"=> "8", "Las Palmas"=> "8", "Vizcaya"=> "8","Asturias"=> "7",
    "Granada"=> "7", "Pontevedra"=> "7", "Santa Cruz de Tenerife"=> "7" ,"Zaragoza" => "7","Almería"=> "6", "Badajoz"=> "6",
    "Córdoba"=> "6", "Gerona"=> "6", "Guipúzcoa"=> "6", "Tarragona"=> "6","Toledo"=> "6","Cantabria"=> "5", "Castellón"=> "5",
