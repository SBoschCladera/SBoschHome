        ...
        <div class="row">
            <div class="col-md-6 listing-block">
                <?php foreach ($properties as $property) { ?>
                    <div id="property-<?php echo $property->getId(); ?>" class="media">
                        <div class="fav-box">
                            <a href="?propertyId=<?php echo $property->getId(); ?>">
                                <i class="fa fa-map-pin " <?php echo($selectedPropertyId == $property->getId() ? "style='color:red'" : "") ?> aria-hidden="true"></i>
                            </a>
                        </div>
